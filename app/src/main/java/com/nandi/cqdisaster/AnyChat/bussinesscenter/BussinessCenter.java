package com.nandi.cqdisaster.AnyChat.bussinesscenter;
...
import com.nandi.cqdisaster.AnyChat.activity.VideoActivity;
import com.nandi.cqdisaster.AnyChat.util.BaseConst;
import com.nandi.cqdisaster.AnyChat.util.BaseMethod;
import com.nandi.cqdisaster.AnyChat.util.ScreenInfo;
...
public class BussinessCenter{
	...
	private void playCallReceivedMusic(Context context) {
		mMediaPlaer = MediaPlayer.create(context, R.raw.alarm);
