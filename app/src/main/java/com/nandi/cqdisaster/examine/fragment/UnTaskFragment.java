...
import com.nandi.cqdisaster.examine.activity.UnCompleteActivity;
import com.nandi.cqdisaster.examine.adapter.UnTaskAdapter;
...
public class UnTaskFragment extends Fragment  {
    ...
    private void initData() {
        TaskBeanDao taskBeanDao = MyAPP.getDaoSession().getTaskBeanDao();
