...
import com.nandi.cqdisaster.examine.adapter.QueryDisasterAdapter;
...
public class QueryDisasterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(QueryDisasterActivity.this);

        rcQueryDisaster.setLayoutManager(mLayoutManager);
        //固定高度
        rcQueryDisaster.setHasFixedSize(true);
        //绑定adapter
        mAdapter = new QueryDisasterAdapter(QueryDisasterActivity.this, mListQueryData);
                        ...
                        public void onResponse(String response, int id) {
                            ...
                            try {
                                ...
                                if ("200".equals(status)) {
                                    ...
                                    Intent intent = new Intent(QueryDisasterActivity.this, LoginActivity.class);
