...
import com.nandi.cqdisaster.examine.database.TaskBeanDao;
...
public class UnCompleteActivity extends AppCompatActivity {
    ...
    private void setLinsteners() {
        ...
        tvDisaster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(UnCompleteActivity.this, QueryDisasterActivity.class);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getTaskBean();
                MyAPP.getDaoSession().getTaskBeanDao().update(taskBean);
        ...
        btnCancle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyAPP.getDaoSession().getTaskBeanDao().delete(taskBean);
                finish();
            }
    ...
    private void setViewDataAll() {
        taskBean=MyAPP.getDaoSession().getTaskBeanDao().queryBuilder()
