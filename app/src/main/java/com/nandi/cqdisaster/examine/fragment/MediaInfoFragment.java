...
import com.nandi.cqdisaster.examine.adapter.PictureAdapter;
...
import com.nandi.cqdisaster.examine.utils.UriToPath;
...
public class MediaInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        picturePathBeanDao = MyAPP.getDaoSession().getPicturePathBeanDao();
        videoPathBeanDao = MyAPP.getDaoSession().getVideoPathBeanDao();
        audioPathBeanDao = MyAPP.getDaoSession().getAudioPathBeanDao();
        initView();
        setAdapter();
        setListener();
    ...
    private void setListener() {
        ...
        btnBaseinfoPhotoUpload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                btnBaseinfoPhotoUpload.setEnabled(false);
        ...
        OkHttpUtils.get().url(new ConnectUrl().getTaskStatusUrl())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        ...
                        btnBaseinfoPhotoUpload.setEnabled(true);
                    }
